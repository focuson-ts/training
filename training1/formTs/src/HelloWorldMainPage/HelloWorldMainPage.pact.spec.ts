...
describe ( 'HelloWorldMainPage - restDataRD - fetcher', () => {
  it ( 'should have a  fetcher for HelloWorldDomainData', async () => {
    await provider.addInteraction ( {
      ...
      withRequest: {
        method: 'GET',
        path: '/helloWorld',
        query:{"accountSeq":"accountSeq","applicationRef":"applicationRef","brandRef":"brandRef","clientRef":"clientRef","employmentSeq":"employmentSeq","vbAccountSeq":"vbAccountSeq","vbAccountType":"vbAccountType"}
      },
      willRespondWith: {
        status: 200,
      ...
      const firstState: FState  = { ...emptyState, pageSelection:[{ pageName: 'HelloWorldMainPage', pageMode: 'view' }], CommonIds: {"accountSeq":"accountSeq","applicationRef":"applicationRef","brandRef":"brandRef","clientRef":"clientRef","employmentSeq":"employmentSeq","vbAccountSeq":"vbAccountSeq","vbAccountType":"vbAccountType"} }
  const lensTransforms: Transform<FState,any>[] = [
      ...
      let expectedRaw: any = {
... withIds,
      tags: {'HelloWorldMainPage_~/fromApi': ["accountSeq","applicationRef","brandRef","clientRef","employmentSeq","vbAccountSeq","vbAccountType"]}
      };
